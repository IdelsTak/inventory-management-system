 ...
 * @author Husnain Arif
 */
public class ErrorClassesTracking implements SetChangeListener<PseudoClass> {
    
    private final String title;
    private final String errorDetail;
    private final ObservableSet<InputError> errors;

    public ErrorClassesTracking(String errorTitle, String errorDetail, ObservableSet<InputError> errors) {
